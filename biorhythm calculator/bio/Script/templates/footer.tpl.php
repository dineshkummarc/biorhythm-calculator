  ...
  <div class="container">
    <div class="row p-5">
      <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-3">
        <p>Contact email</p>
        <a class="w-100" href="mailto:serbermz2020@gmail.com">serbermz2020@gmail.com</a>        
        <p class="mt-3"><i class="fal fa-copyright"></i> Copyright <a target="_blank" href="#">CampCodes</a></p>
      </div>
      <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-3">
